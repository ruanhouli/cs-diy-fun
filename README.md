...
[![License](https://img.shields.io/github/license/ruanhouli/cs-diy-fun)](https://github.com/ruanhouli/cs-diy-fun/blob/master/LICENSE)
[![Issues](https://img.shields.io/github/issues/ruanhouli/cs-diy-fun)](https://github.com/ruanhouli/cs-diy-fun/issues)
[![Stars](https://img.shields.io/github/stars/ruanhouli/cs-diy-fun)](https://github.com/ruanhouli/cs-diy-fun)
...
你可以[在线免费阅读这本书](https://csdiy.fun)。

英文版请移步[这里](https://github.com/ruanhouli/Self-learning-Computer-Science)。

## 如何成为贡献者

一个人的力量终究是有限的，对于书中任意章节你若有想要补充的内容，欢迎各位提出 [Pull Request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request-from-a-fork)。如果你想贡献一门新的课程，可以参考目前 repo 中的 [template](./template.md) 文件作为模版，并在 [mkdocs.yml](./mkdocs.yml) 文件中添加其navigation，当然你还可以在 [CS 学习规划](./docs/CS学习规划.md) 里的对应模块为其添加言简意赅的导语。如果你有想推荐的书籍，请参考 [好书推荐](https://raw.githubusercontent.com/ruanhouli/cs-diy-fun/master/docs/%E5%A5%BD%E4%B9%A6%E6%8E%A8%E8%8D%90.md) 模块上方的注释按相应格式添加内容。

对于中英混合排版的要点规范，可以参考[这个仓库](https://github.com/sparanoid/chinese-copywriting-guidelines/blob/master/README.zh-Hans.md)，我们将会对您的 Pull Request 做相应的校对，具体原因参见这个 [issue](https://github.com/ruanhouli/cs-diy-fun/issues/114)。

本书的英文版也正在翻译中，如果你想参与到翻译的队伍里，可以参考这个 [issue](https://github.com/ruanhouli/cs-diy-fun/issues/222)。
...
[![Star History Chart](https://api.star-history.com/svg?repos=ruanhouli/cs-diy-fun&type=Timeline)](https://star-history.com/#ruanhouli/cs-diy-fun&Timeline)

## ✨ 鸣谢

特别感谢 @[AlfredThiel](https://github.com/AlfredThiel) 为项目制作了精美的 Logo。
<!--  support by https://contrib.rocks -->
<a href="https://github.com/ruanhouli/cs-diy-fun/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=ruanhouli/cs-diy-fun"/>
</a>
